            ...
            <div class="modal-body">
                <form action="">
                    ...
                    <div>
                        ...
                        <input type="text" id="product-name" value="Milo">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="brand" value="Nestle">
                    </div>
                    <div>
                        <label for="barcode">Barcode:</label>
                        <input type="text" id="barcode" value="12121212121">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="stock" value="500">
                    </div>
